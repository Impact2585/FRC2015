...
public class RoboRealmSystem implements RobotSystem, ITableListener {
    private final double MIN_AREA=0; //The value is 0 for testing purposes only.
    private final double MAX_AREA=1; //The value is 1 for testing purposes only.
    private double distance;
    private final double DISTANCE_CONSTANT=0; //The value is 0 for testing purposes only.
    private double area;
    ...
    public void setNums()
    {
    	...
    	if(MIN_AREA<area&&area<MAX_AREA) {distance=area/DISTANCE_CONSTANT;}
    	else {area=-5555;}
    }
